...
Implements length checks; includes TODO for entropy threshold tuning.
...
def detect_dns(cfg, pkt, src, dst) -> None:
    ...
    ent = _entropy(name)
    # TODO(student): consider moving this threshold into config.yaml if you want to tune it
